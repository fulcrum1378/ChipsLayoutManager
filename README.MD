...
## Setup and usage
### Installation [ ![Download] ](https://bintray.com/beloo/widget/ChipsLayoutManager/_latestVersion)

with gradle
```GRADLE 
implementation 'ir.mahdiparastesh:chipslayoutmanager:0.4.0@aar'
```
...
allprojects {
    repositories {
        maven { url = uri("https://maven.pkg.github.com/fulcrum1378/ChipsLayoutManager") }
    }
}
```
